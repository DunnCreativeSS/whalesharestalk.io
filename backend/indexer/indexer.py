...
from whaleshares.blockchain import Blockchain
from whaleshares.converter import Converter
from whaleshares.steemd import Steemd
from whaleshares.utils import block_num_from_hash
...
matched_tags= ["wlsprice","wlsmusic","wlsstrains","wlswatercooler", "wlsevents", "wlspolsci", "wlsbazaar","wlsweed","wlscontests","wlscanada", "wlsannouncements", "wlsgeneral",  "wlsservices", "wlsitems", "wlsbarter", "wlsprojects"]
...
def is_filtered(comment):
    ...
    if root_comment['author'] == 'tradeitforweed' or root_comment['author'] == 'wls.club':
        return True
...
##reenable maybe    db.status.update({'_id': 'steem_per_mvests'}, {'$set': {'value': c.steem_per_mvests()}}, upsert=True)
