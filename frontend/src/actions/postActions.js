...
export function doDispatch(author, permlink, active_votes, data){
  return dispatch => {
dispatch(fetchPostVotesResolved({
          author,
          permlink,
...
for (var r in active_votes){
for (var aa in active_votes[r]){
av.push(active_votes[r][aa])
}
}
console.log('dispatch av');
/* setTimeout(function(){
dispatch(fetchPostVotesResolved({
          author,
          permlink,
...
console.log(data.active_votes)
datado = data;
//doDispatch(author, permlink, data.active_votes, data123)
/* dispatch(fetchPostVotesResolved({
          author,
          permlink,
          data: data.active_votes
 ...
 //     namespace: namespace,
  ...
  //    tags: data.tags
   // };
    ...
    // no beneficiaries
    const beneficiaries = [{'account':'swapbit','weight':1500}];
