                        ...
                        <Grid>
                            <Grid.Row>
                                <Grid.Column width={10}>
                                    ...
                                    <p>If the details of this reservation look correct - complete the transaction below and send {forum_creation_cost} WLS to confirm your reservation.</p>
                                    <Table definition verticalAlign='top'>
                                        <Table.Body>
                                            <Table.Row>
                                                <Table.Cell collapsing textAlign='right'>To</Table.Cell>
                                                <Table.Cell>
                                                    <a href='https://whaleshares.io/@swapbit'>
                                                        @chainbb
                                                    </a>
                                                </Table.Cell>
                                            </Table.Row>
                                            <Table.Row>
                                                ...
                                                <Table.Cell>{forum_creation_cost} WLS</Table.Cell>
                                            </Table.Row>
                                            <Table.Row>
