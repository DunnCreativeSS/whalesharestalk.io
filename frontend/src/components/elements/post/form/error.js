        ...
        <Modal.Content>
          ...
          <Form>
           <Form.Field
             ...
             name='error'
           />
           <p>If you need assistance, please notify here on the forums, on whaleshares.io. Please include the error messages, all of the text in the box above, and a description of what you were attempting to do.</p>
         </Form>
        </Modal.Content>
        <Modal.Actions>
