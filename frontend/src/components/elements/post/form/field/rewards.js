...
const options = [
  {
    ...
    text: '100% WLS Power',
    value: 'sp',
    content: <Header content='100% WLS Power' subheader='Rewards earned 100% in WLS Power.' />,
  },
  {
    key: 'decline',
      ...
      <Grid stackable={true}>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <Header>
              <Header.Subheader>
                This option only applies to you as the author. All other beneficiaries will be rewarded in 100% WLS Power.
              </Header.Subheader>
            </Header>
          </Grid.Column>
          <Grid.Column width={8}>
            <Segment secondary>
              ...
              <Header>
                <Header.Subheader>
                  swapbit takes 5% on this forum.
                </Header.Subheader>
                <Header.Subheader>
                  <small>
                    <strong>*</strong>
                    {' '}
                    Represents the actual percentage after the swapbit beneficiary, but before curation.
                  </small>
                </Header.Subheader>
              </Header>
            </Segment>
