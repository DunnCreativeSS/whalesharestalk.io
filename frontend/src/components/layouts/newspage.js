      ...
      <Grid>
        <Grid.Row>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="General" feed="swapbit-general" imageSize="small" titleSize="ui header tiny" max={3} />
          </Grid.Column>
          <Grid.Column mobile={16} tablet={4} computer={4}>
            <Section1 title="Announcements" feed="swapbit-announcements" imageSize="mini" titleSize="small" showMeta={false} max={7} />
        ...
        <Grid.Row>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="Canada" feed="swapbit-canada" titleSize="ui header tiny" max={3} />
          </Grid.Column>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="WhaleShares" feed="swapbit-smoke2" titleSize="ui header tiny" max={3} />
          </Grid.Column>
        </Grid.Row>
